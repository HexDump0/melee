...
/* P-796: print every live fighter's kinematics and the camera bone's joint
 * chain.  Registered with boot_triage so the assert, panic and signal paths
 * all emit it; safe to call at any time, including when no match is live. */
