...
| P-211 | Renderer rewrite: OpenGL 3.3 core + ES3/WebGL2-portable GLSL 330 (supersedes ADR-0004) | open | — | `native/main.c`, `native/CMakeLists.txt`, `native/AI/DECISIONS.md` | Foundation for P-204. Spike offscreen 3.3 core first, write ADR-0009, keep screenshots deterministic and `--inspect` unchanged. |
