...
| P-641 | Final Destination center effects render opaque/black instead of soft translucent blue/purple fades (owner comparison, 2026-09-13) | claimed | Codex, 2026-09-13 | `native/decomp/gx/`, `native/decomp/assets/hsd_convert.c`, `native/tests/` | Trace stage XLU draws, TEV alpha, blend factors, and texture alpha against the supplied Dolphin reference; preserve compiled GX state rather than adding stage-specific filtering. All automated viewer runs use dummy SDL audio. |
