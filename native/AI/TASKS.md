...
| P-668 | S8.5: web path — keep wasm32+GLES green through the migration, then point wasm at the schema layer; Emscripten + WebGL2 smoke | open | — | `native/`, `native/AI/ROADMAP_DETAILS.md` | ADR-0015, P-502. Acceptance: wasm build + documented headless browser smoke. |
