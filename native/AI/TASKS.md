...
| P-631 | Link's head/cap shows a rogue green polygon in the live match (owner report 2026-09-12; present before and after P-627). Not NaN-related: matrix/angle probes are clean. Investigation state and repro commands in `logs/2026-09-12-P-631-link-head.md` | open | — | `native/decomp/gx/`, `native/decomp/assets/hsd_convert.c`, compiled ftParts/PObj/HSD paths | Repro: `SDL_VIDEODRIVER=offscreen ./build/native/melee_decomp_viewer --match --frames 718 --shot /tmp/head.bmp`; close-crop Link's head. Scan found giant off-screen triangles in 6-vertex fighter-textured quads (frame 900 draw 74 tex0=30, 930 draw 83 tex0=39, 990/1020 draw 45 tex0=26) and a 0.42-NDC-area triangle in draw 71 (tex0=26) at frame 1200, but none was confirmed visible on screen. Next: isolate fighter-textured 6-vertex quads (raycast/rasterize the captured draws), or compare against the prototype viewer. Do not filter at GX. |
