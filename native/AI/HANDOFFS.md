...
|---|---|---|---|
| 2026-09-18 | **P-848/P-849 fixed: one byte-swapped `u16` inside a GX display list drew Battlefield as shards; six archives were affected** | claude (opus-5 1M) | [`2026-09-18-P-849-display-list-guard.md`](handoffs/2026-09-18-P-849-display-list-guard.md) — G-222; the guard now sits on the display list, not on one descriptor type |
