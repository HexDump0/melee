#ifndef MELEE_NATIVE_HSD_AOBJ_H
#define MELEE_NATIVE_HSD_AOBJ_H
 ...
 * "fobj_req_anim(f, frame); fobj_interpret(f, 0, &value)".
 */
#include <stddef.h>
#include <stdint.h>
